...
binom_results <- data.frame(matrix(ncol = 8, nrow = 0))
...
colnames(binom_results) <- c('community','stage','scale','dom_cycle','total_cycles_n','dom_cycle_n','second_cycle_n','sig') # assign column names
